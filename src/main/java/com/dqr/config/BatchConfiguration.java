...
import com.dqr.jobs.JobCompletionNotificationListener;
import com.dqr.jobs.QuoteItemProcessor;
...
public class BatchConfiguration {
    ...
    @Bean
    public QuoteItemProcessor processor() {
        return new QuoteItemProcessor();
    }

    @Bean
    public ItemWriter<SvcReq> writer() {
        return new QuoteSvcInvoker();
    }
